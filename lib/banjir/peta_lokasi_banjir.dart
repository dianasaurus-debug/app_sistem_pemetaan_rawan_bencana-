...
class PetaLokasiBanjir extends StatefulWidget {
  @override
  _PetaLokasiBanjirState createState() => _PetaLokasiBanjirState();
}

class _PetaLokasiBanjirState extends State<PetaLokasiBanjir> {
