...
class PetaRawanKekeringan extends StatefulWidget {
  @override
  _PetaRawanKekeringanState createState() => _PetaRawanKekeringanState();
}

class _PetaRawanKekeringanState extends State<PetaRawanKekeringan> {
  ...
  void setRendah() async {
    iconRendah = await getBitmapDescriptorFromAssetBytes("images/drought_rendah.png", 120);
  }
  void setSedang() async {
    iconSedang = await await getBitmapDescriptorFromAssetBytes("images/drought_sedang.png", 120);
  }
  void setTinggi() async {
    iconTinggi = await await getBitmapDescriptorFromAssetBytes("images/drought_tinggi.png", 120);
  }
  @override
  void initState() {
    super.initState();
        ...
        if(bencana_rawan.status==0){
          final marker = Marker(
              ...
              infoWindow: InfoWindow(
                title: 'Kemungkinan kekeringan rendah',
          ...
          final marker = Marker(
              ...
              position: LatLng(bencana_rawan.latitude, bencana_rawan.longitude),
              infoWindow: InfoWindow(
                title: 'Kemungkinan kekeringan sedang',
                snippet: bencana_rawan.desa,
              ),
              icon: iconSedang
          );
          ...
          final marker = Marker(
              ...
              position: LatLng(bencana_rawan.latitude, bencana_rawan.longitude),
              infoWindow: InfoWindow(
                title: 'Kemungkinan kekeringan tinggi',
                snippet: bencana_rawan.desa,
              ),
              icon: iconTinggi
          );
