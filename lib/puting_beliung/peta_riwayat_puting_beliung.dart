...
class PetaRiwayatPutingBeliung extends StatefulWidget {
  @override
  _PetaRiwayatPutingBeliungState createState() => _PetaRiwayatPutingBeliungState();
}

class _PetaRiwayatPutingBeliungState extends State<PetaRiwayatPutingBeliung> {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text('Peta Riwayat Puting Beliung',
